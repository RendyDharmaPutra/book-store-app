...
function Profile({ path }: { path: string }) {
	...
	return (
		<>
			<section
				onClick={() => setShow(!show)}
				className={`nav-item md:px-2 md:py-1 justify-between border border-gray-200 ${
...
function ProfileMenu() {
	return (
		<section className={`p-1 flex flex-col gap-1 w-[8rem] rounded-xl bg-white`}>
			...
			<button className="p-1 flex flex-row items-center justify-start gap-1 md:gap-2 w-full rounded-lg hover:bg-red-100 duration-200">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
